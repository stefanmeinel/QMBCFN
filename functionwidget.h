...
class FunctionWidget: public QWidget
{
  ...
  public:
    ...
    void set_function_name(int f, std::string name);
    std::string get_function_name(int f);

    void set_function_active(int f, bool active);
    bool get_function_active(int f);
  ...
  signals:
    ...
    void function_active_changed(int f, bool active);
    void function_name_changed(int f, std::string new_name);

  private slots:
    void modified_slot();
    void n_functions_modified_slot(int new_n_functions);
    void functions_changed_slot(const QModelIndex&, const QModelIndex&);
    void function_active_changed_slot(const QModelIndex&, const QModelIndex&);
    void function_names_changed_slot(const QModelIndex&, const QModelIndex&);
